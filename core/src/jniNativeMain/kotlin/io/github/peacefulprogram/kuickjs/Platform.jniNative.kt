...
fun _initializeJsFunctionBridgeJni(
    ...
    val state = ContextEnv(
        ...
        platformClass = env.NewGlobalRef(clazz),
        bridgeMethodId = env.GetStaticMethodID(clazz, "onJsBridgeFunctionCall", "(JIZ[J)J"),
...
fun _freeContext(
    ...
    JS_GetContextOpaque(context.toCPointer())?.let { opaque ->
